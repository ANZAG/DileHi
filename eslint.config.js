...
export default tseslint.config(
  {
    ignores: [
      ...
      "scripts/**",
      "supabase/functions/**",
      // types.ts erzeugt die Supabase-CLI (supabase gen types) – eine Korrektur
      // von Hand hielte bis zum nächsten Lauf. Bis September 2026 erzeugte
      // Lovable hier auch client.ts und eine Hilfsdatei für die Vorschau.
