  ...
  const { data: galleryImages = [] } = useQuery({
    ...
    queryFn: async () => {
      ...
      return data.map((img) => {
        ...
        return { src: urlData.publicUrl, alt: img.alt_text || "Darstellung Erster Weltkrieg Pioniere", showSubtitle: img.show_subtitle ?? false };
      });
    },
  });
